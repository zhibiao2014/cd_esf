      ...
      <div class="p10">
        ...
        <div class="un1_box t_no w380 fr">
          <ul class="Flist clearfix p10">
            ...
            <li class="pr tslw"><em>单价：</em><span>{{{ empty($house->construction_area) ? '待定' : ceil($house->price * 10000 / $house->construction_area) . '元/㎡' }}}</span></li>
            <li><em>户型：</em><span>{{{$house->room}}}室{{{$house->hall}}}厅{{{$house->bathroom}}}卫</span></li>
            <li><em>面积：</em><span>{{{$house->construction_area ? $house->construction_area . '㎡' : ''}}}</span></li>
          ...
          <ul class="Flist clearfix p10">
            ...
            <li><em>朝向：</em><span>{{{isset($directions[$house->direction_id]) ? $directions[$house->direction_id]['name'] : ''}}}</span></li>
    ...
    <div class="one_box mb10 p10">
      <div class="house_detail">
        ...
        <div class="describe mt10">
          {{ \lib\Tool::trim_script($house->content) }}
        </div>
        <div class="clear"> </div>
      </div>
    </div>
        ...
        <div class="introduct mt10">
          <dl class="mt10">
            <dt>
              ...
              ( {{{ isset($cdfdc_regions[$community->area]) ? $cdfdc_regions[$community->area]['name'] : '' }}} )  &nbsp;&nbsp;
    ...
    <div class="un1_box one_box mb10">
      ...
      <ul class="column_c clearfix">
        ...
        <li>
          ...
          <span class="wid45">{{{$house->construction_area ? $house->construction_area . '㎡' : ''}}}</span><span class="wid60 c1">{{{$value['price']}}}万</span>
        </li>
        @endforeach
      </ul>
      @endif
