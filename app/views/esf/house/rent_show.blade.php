      ...
      <div class="p10">
        ...
        <div class="un1_box t_no w380 fr">
          <ul class="Flist clearfix p10">
            <li><em>价格：</em><span class="c1 f16">{{{$house->price}}}</span>元/月</li>
            <li><em>联系人：</em><span class="c1 f16">{{{$house->contacts}}}</span></li>
            <li class="pr tslw">
            <em>租赁方式：</em>
            <span>{{{$rent_methods[$house->rent_method_id]['name']}}}</span>
            </li>
  ...
  <div class="fr esfcenRt">
    ...
    <div class="un1_box one_box mb10">
      ...
      <ul class="column_c clearfix">
        ...
        <li>
          <span class="wid75">
            <a title="{{{$value['title']}}}" href="{{{route('esf.rent.show', $value['id'])}}}">{{{$value['title']}}}</a>
          </span>
          <span class="wid45"> {{{$value['construction_area']}}}㎡</span><span class="wid60 c1">{{{$value['price']}}}元/月</span>
        </li>
        @endforeach
      </ul>
      @endif
