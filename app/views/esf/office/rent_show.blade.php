      ...
      <div class="p10">
        ...
        <div class="un1_box t_no w380 fr">
          <ul class="Flist clearfix p10">
            ...
            <li><em>租金：</em><span class="c1 f16">{{{$house->price}}}</span>元/月</li>
            <li class="pr tslw"><em>支付方式：</em><span>{{{ isset($pay_methods[$house->pay_method_id]) ? $pay_methods[$house->pay_method_id]['name'] : '面议' }}}</span></li>
            <li><em>楼层：</em><span>第{{{$house->floor['floor']}}}层，共{{{$house->floor['total_floor']}}}层</span></li>
