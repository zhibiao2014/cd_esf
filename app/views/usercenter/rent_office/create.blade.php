...
<div class="set_cent fr">
  ...
  @endif
  {{ HTML::ul($errors->all()) }}
  {{ Form::open(array( 'route' => array('rent_office.store'), 'id' => 'residence' )) }}
  ...
  <div class="msglist mb20">
    <ul class="tab03 type_tab">
      <li>
        ...
        <label class="tab02">
          <input type="radio" value="" name="public" data-url="<?php echo route('rent_office.create'); ?>" checked="checked"/>
    ...
    <div class="msglist mb20">
      <ul>
        <li class="pr">
          ...
          {{ Form::text('info[community_name]', Input::old('info[community_name]'), array('class' => 'Input_1', 'style' => 'width:300px;', 'id' => 'community_name', 'autocomplete' => 'off' )) }}
        ...
        <li>
          ...
          <label><input type="radio" value="1" checked="checked" name="info[is_include_property_costs]" /> 是 </label>
          <label><input type="radio" value="0" name="info[is_include_property_costs]" /> 否 </label>
        </li>
        <li>
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $("#validity").formValidator({onshow:"请选择有效期",onfocus:"请选择有效期"}).inputValidator({min:1,onerror:"有效期是必选项"});
