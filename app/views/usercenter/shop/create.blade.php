...
<div class="set_cent fr">
  ...
  @endif
  {{ HTML::ul($errors->all() )}}
  {{ Form::open(array( 'route' => array('shop.store'), 'id' => 'residence' )) }}
  ...
  <div class="msglist mb20">
    <ul class="tab03 type_tab">
      <li>
        ...
        <label class="tab02">
          <input type="radio" value="" name="public" checked="checked" data-url="<?php echo route('shop.create'); ?>" />
  ...
  <div id="con_one_1">
    ...
    <div class="msglist mb20">
      <ul>
        ...
        <li>
          ...
          {{ Form::text('info[price]', Input::old('info[price]'), array('class' => 'Input_1', 'style' => 'width:120px;', 'id' => 'price' )) }} 万元/套
        </li>
    ...
    <div class="msglist mb20">
      <ul>
        ...
        <li class="clearfix">
          <label class="w127 flptao" for="input_DESCRIPTION">商铺描述：</label>
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $("shop_manager_type_check").formValidator({onshow:"请选择营类别",onfocus:"请填写选择营类别"}).functionValidator({fun:function(val,elem){ return true; }});
