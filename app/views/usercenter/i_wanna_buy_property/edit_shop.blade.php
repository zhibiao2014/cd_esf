      ...
      <ul>
        ...
        <li>
          ...
          <div class="frptao">
            ...
            <label class="w127 fwptcheck"><input type="checkbox" value="<?php echo $value['id']; ?>" name="info[type_id][]" autocomplete="off" class="type" <?php if( in_array($value['id'], $i_wanna_buy_property['type_id']) ) { echo "checked"; } ?>/><?php echo $value['name']; ?></label>
            <?php } ?>
        ...
        <li class="clearfix">
          ...
          <div class="frptao">
            ...
            <label class="w127 fwptcheck"><input type="checkbox" value="<?php echo $value['id']; ?>" name="info[shop_manager_type][]" autocomplete="off" <?php if( in_array($value['id'], $i_wanna_buy_property['shop_manager_type']) ) { echo "checked"; } ?>/><?php echo $value['name']; ?></label>
            <?php } ?>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    $("#type").formValidator({onshow:"请选择商铺类型",onfocus:"请选择商铺类型"}).functionValidator({fun:function(val,elem){ if( $('.type:checked').length > 0 ) { return true; } else { return "商铺类型必选"; } }}).defaultPassed();
