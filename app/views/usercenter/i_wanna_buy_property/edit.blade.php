    ...
    <div class="msglist mb20">
      <ul>
        ...
        <li>
          ...
          {{ Form::text('info[room_structure][room]', $i_wanna_buy_property['room_structure']['room'], array('class' => 'Input_1', 'style' => 'width:32px;', 'id' => 'input_House_Room' )) }}
          <span>室</span>
          {{ Form::text('info[room_structure][hall]', $i_wanna_buy_property['room_structure']['hall'], array('class' => 'Input_1', 'style' => 'width:32px;', 'id' => 'input_House_Hall' )) }}
          <span>厅</span>
          {{ Form::text('info[room_structure][bathroom]', $i_wanna_buy_property['room_structure']['bathroom'], array('class' => 'Input_1', 'style' => 'width:32px;', 'id' => 'input_House_Toilet' )) }}
          <span>卫</span>
        </li>
        <li>
        ...
        <li>
          ...
          {{ Form::text('info[house_age]', $i_wanna_buy_property['house_age'], array('class' => 'Input_1', 'style' => 'width:58px;', 'id' => 'house_age' )) }}
        ...
        <li>
          ...
          <select class="input_7" name="info[direction_id]" id="slt_House_Forward">
            <option value="">朝向需求</option>
            <?php foreach ($directions as $key => $direction) { ?>
            <option value="<?php echo $direction['id']; ?>"<?php if( $direction['id'] == $i_wanna_buy_property['direction_id'] ) {echo " selected";} ?>><?php echo $direction['name']; ?></option>
            <?php } ?>
          </select>
