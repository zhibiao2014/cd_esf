  ...
  <div class="msglist mb20">
    <ul class="tab03 type_tab">
      <li>
        ...
        <label class="tab02">
          <input type="radio"  name="info[type]" value="2" checked="checked" data-url="<?php echo route('i_wanna_buy_property.create', array('model' => 'office')); ?>" />
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    $("#type").formValidator({onshow:"请选择写字楼类型",onfocus:"请选择写字楼类型"}).inputValidator({min:1,onerror:"写字楼类型必选"});
