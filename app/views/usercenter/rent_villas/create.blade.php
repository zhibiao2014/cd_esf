...
<div class="set_cent fr">
  ...
  @endif
  {{ HTML::ul($errors->all()) }}
  {{ Form::open(array( 'route' => array('rent_villas.store'), 'id' => 'residence' )) }}
  ...
  <div class="msglist mb20">
    <ul>
      <li>
        ...
        <input type="text" value="" class="Input_1" name="info[contacts]" id="contacts"/>
      </li>
      <li class="phone">
  ...
  <div class="msglist mb20">
    <ul class="tab03 type_tab">
      <li>
        ...
        <!-- <label class="tab02">
          <input type="radio" value="" name="public" data-url="<?php echo route('rent_villas.create'); ?>" checked="checked" />
        ...
        <label class="tab02">
          <input type="radio" value="" name="public" data-url="<?php echo route('rent_shop.create'); ?>" />
      ...
      <ul>
        ...
        <li>
          ...
          <select class="input_7" name="info[rent_method_id]" id="rent_method_id">
            ...
            <?php foreach ($rent_methods as $key => $rent) { ?>
            <option value="<?php echo $rent['id']; ?>"><?php echo $rent['name']; ?></option>
            <?php } ?>
          </select>
        </li>
        <li>
        ...
        <li>
          ...
          {{ Form::text('info[construction_area]', Input::old('info[construction_area]'), array('class' => 'Input_1', 'style' => 'width:120px;', 'id' => 'construction_area' )) }}
        </li>
        <li>
          <label class="w127" for="input_House_Floor"><span class="c1">*</span>楼层：</label>
          共
          {{ Form::text('info[floor]', Input::old('info[floor]'), array('class' => 'Input_1', 'style' => 'width:32px;', 'id' => 'floor' )) }}
          层
        </li>
        <li>
        ...
        <li>
          ...
          {{ Form::text('info[price]', Input::old('info[price]'), array('class' => 'Input_1', 'style' => 'width:120px;', 'id' => 'price' )) }} 元/月
        </li>
        <li>
...
<script type="text/javascript">
  ...
  $(function() {
    ...
    $("#pay_method_id").formValidator({onshow:"请选择支付方式",onfocus:"请选择支付方式"}).inputValidator({min:1,onerror:"支付方式必选"});
    ...
    $("#floor").formValidator({onshow:"请填写总楼层",onfocus:"请填写总楼层"}).inputValidator({min:1,onerror:"总楼层必须为正整数"});
